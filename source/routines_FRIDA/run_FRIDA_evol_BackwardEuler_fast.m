function [OUTPUT_FRIDA]=run_FRIDA_evol_BackwardEuler_fast(SETTINGS)
...
Q_tilde = h_step*A_phic_inv*B_pla*KK_D/mu0;
Q_tilde_bc = h_step*A_phic_inv*B_pla*KK_bc/mu0;
...
% %             [solk1]=fun_Picard_FRIDA(INPUT_solver);
        ...
        case 'NR' % Newtok-Raphson
            [solk1]=fun_NR_FRIDA_evol_BackwardEuler_fast(INPUT_solver);
            
            
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%
        case 'NK' % Newtok-Krylov
            [solk1]=fun_NK_FRIDA_evol_BackwardEuler_fast(INPUT_solver);  %  Newtok-Krylov scaled lambda

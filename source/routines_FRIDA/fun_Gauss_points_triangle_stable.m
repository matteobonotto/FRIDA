function [ww,nodes,n_Gauss] = fun_Gauss_points_triangle_stable(P1,P2,P3,GAUSS_QUAD_DEGREE)  %#codegen
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
[xyw]=fun_Gauss_points_unit_triangle_Dunavant(GAUSS_QUAD_DEGREE);
% % [xyw]=set_best_rule_triangle(GAUSS_QUAD_DEGREE);
n_Gauss = size(xyw,1);

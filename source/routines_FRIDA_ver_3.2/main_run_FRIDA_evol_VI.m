...
if SETTINGS.PREPROC == true
    ...
    load(['INPUT_FRIDA_evol_VI_geo_preproc_' SETTINGS.filename_geo], ...
        'meshData_pla', ...
        'meshData_ext')
...
if SETTINGS.ii_START == 1
    ...
    [OUTPUT_FRIDA_t0] = run_FRIDA_evol_t0(meshData_pla,meshData_ext,Conductors_t0,plaparameter_t0,SETTINGS);
...
if SETTINGS.IS_EVOL
    ...
    for ii_CN = SETTINGS.ii_START+1:n_time
        ...
        try
            ...
            % %             save(filename_save, 'solk_old')
            solk_old = solk_old_save;
            
            % %             figure
            % %             plot3(meshData_pla.n(meshData_pla.ind_D,1),meshData_pla.n(meshData_pla.ind_D,2), ...
            % %                 SETTINGS.xx_0(1:meshData_pla.nn_D),'o')

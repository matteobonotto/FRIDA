...
load([input_Data, 'RFXmod_mesh_VI_linear.mat'])
meshData_ext = meshData;
load([input_Data, 'RFXmod_mesh_pla.mat'])
...
filename_geo = 'RFXmod_36922_rampdown'; % personalize suffix of geo data file and save it
save(['INPUT_FRIDA_geo_' filename_geo],'meshData_pla', 'meshData_ext')
...
filename_equil = 'RFXmod_36922_rampdown';
save(['INPUT_FRIDA_equil_' filename_equil],...
    'plaparameter', ...
    'Conductors')

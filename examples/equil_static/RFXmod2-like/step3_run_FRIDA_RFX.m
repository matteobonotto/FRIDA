...
%% SETTINGS
% filename = 'RFXmod2_28906_static'; % specify preproc data filename (if preproc already run)
...
load('./data_in_FRIDA/tmp_INPUT_FRIDA_equil.mat');
save(['./data_in_FRIDA/INPUT_FRIDA_equil_', SETTINGS.filename, '.mat'], ...
    'IE_evol');

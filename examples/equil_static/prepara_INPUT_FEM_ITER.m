...
% % mesh_Name = 'ITER_meshData_FRIDA_evol_MR';
% % mesh_Name = 'ITER_meshData_FRIDA_evol_LR';
% % mesh_Name = 'ITER_meshData_FEM_BEM';


%% Adding folder path
addpath ../routines_FRIDA_ver_2.0
...
% % filename_save =  sprintf('_ITER_LR_%1.5i',equilname);  mesh_Name = 'ITER_meshData_FRIDA_LR';
filename_save =  sprintf('_ITER_MR_%1.5i',equilname);  mesh_Name = 'ITER_meshData_FRIDA_MR';
% % filename_save =  sprintf('_ITER_HR_%1.5i',equilname);  mesh_Name = 'ITER_meshData_FRIDA_HR';

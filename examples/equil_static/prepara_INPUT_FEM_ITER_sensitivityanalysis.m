...
%%
filename_save = '_ITER_00051';
% % filename_save = '_ITER_00090';
filename_save = '_ITER_00049';
filename_save = '_ITER_00155';

input_Equil ='./ITER/EQUIL/';


filename_save_tot = ['ITER_00047'; ...
    'ITER_00048'; ...
    'ITER_00049'; ...
    'ITER_00051'; ...
    'ITER_00067'; ...
...
filename_save_tot = sprintf('ITER_%1.5i.mat\n',1:500);

ind_ok = [];
for ii=1:500
    
    filename_save = sprintf('Equil_%1.5i_CL4E.mat',ii);
    
    file_psi_data =  [input_Equil filename_save];
...
for hhh = 1:length(ind_ok)
    
    waitbar(hhh/length(ind_ok),hh)
    
    filename_save = sprintf('Equil_%1.5i_CL4E.mat',ind_ok(hhh));
    file_psi_data =  [input_Equil filename_save];
    
    equilname = sprintf('%1.5i',ind_ok(hhh));
    ...
    % %         case 1
    % %             equilname='00047'; % ok
    % %             file_psi_data =  [input_Equil  'Equil_00047_CL4E.mat'];
    % %
    % %         case 2
    % %             equilname='00048'; % ok
    % %             file_psi_data =  [input_Equil  'Equil_00048_CL4E.mat'];
    % %
    % %         case 3
    % %             equilname='00049'; % ok
    % %             file_psi_data =  [input_Equil  'Equil_00049_CL4E.mat'];
    % %
    % %         case 4
    % %             equilname='00051'; % ok
    % %             file_psi_data =  [input_Equil  'Equil_00051_CL4E.mat'];
    % %
    % %         case 5
    % %             equilname='00067'; % ok
    % %             file_psi_data =  [input_Equil  'Equil_00067_CL4E.mat'];
    % %
    % %         case 6
    % %             equilname='00080'; % ok
    % %             file_psi_data =  [input_Equil  'Equil_00080_CL4E.mat'];
    % %
    % %         case 7
    % %             equilname='00083'; % ok
    % %             file_psi_data =  [input_Equil  'Equil_00083_CL4E.mat'];
    % %
    % %         case 8
    % %             equilname='00090'; % ok
    % %             file_psi_data =  [input_Equil  'Equil_00090_CL4E.mat'];
    % %
    % %         case 9
    % %             equilname='00096'; % ok
    % %             file_psi_data =  [input_Equil  'Equil_00096_CL4E.mat'];
    % %
    % %         case 10
    % %             equilname='00120'; % ok
    % %             file_psi_data =  [input_Equil  'Equil_00120_CL4E.mat'];
    % %
    % %         case 11
    % %             equilname='00155'; % ok
    % %             file_psi_data =  [input_Equil  'Equil_00155_CL4E.mat'];
    % %
    % %
    % %     end
    ...
    % %             dP=       plaparameter.dP;
    % %             fdfn=interp1(psibar,FdF,psi_nor,'pchip');   %cubic interpolation
    % %             dpn=interp1(psibar,dP,psi_nor,'pchip');     %cubic interpolation
    % %             jphi=(rr(ind_n_INpla).*dpn+fdfn./(mu0*rr(ind_n_INpla))); %computation of nodes plasma current density
    % %             JP.facevertexcdata(ind_n_INpla)=jphi;
    % %             Iphi=zeros(nn,1);
    % %             Iphi(ind_n_INpla)=meshData_loc.Area_d(ind_n_INpla).*jphi;
    ...
    % % end
    N_order = 2;
    % % mesh_Name = 'ITER_meshData_FEM_BEM_fine';
    mesh_Name = 'ITER_meshData_FEM_BEM_2';
    % % mesh_Name = 'ITER_meshData_FEM_BEM';
